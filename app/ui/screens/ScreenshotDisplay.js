...
require('./ScreenshotDisplay.less')

class ScreenshotDisplay extends React.Component {
    constructor(...args) {
        super(...args)
            ...
            <div className="gui-overlay" style={style}>
                <div className="screenshot-display">
                    <div className="image-container">
                        <img src={state.screenshot.dataURL} onClick={() => state.screenshot.hide()}/>
                    </div>
                </div>
...
module.exports = ScreenshotDisplay
